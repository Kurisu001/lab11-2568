...
export default function ModalRegister() {
  ...
  const [agreeClicked, setAgree] = useState(false);
          ...
          <div className="modal-body">
            ...
            <div className="mt-2">
              ...
              <div>
                ...
                <div className={"text-danger" + (genderError ? "" : " d-none")}>
            ...
            <span
              className={"text-success d-block" + (discountCheck() ? " " : " d-none")}
            >
              (20% Discounted)
            </span>
